...
const translations = {
  en: {
    ...
    'svc-music-p':  'Original scores and soundtracks for games, series, film and live ceremonies. From orchestral composition to electronic production, built around your story, not ours.',
    'svc-sound-h3': 'Bespoke Sound Design',
    'svc-sound-p':  'Custom SFX, ambients and sonic atmospheres built from scratch. From the quietest texture to the hardest impact. Every sound placed with intention.',
    'svc-interactive-h3': 'Audio for Interactive Media',
    'svc-interactive-p':  'Adaptive music and dynamic sound systems built for games. We\'ve worked with studios reaching over 2 billion players. We know how audio drives engagement at scale.',
    'svc-post-h3':  'Post, Mix &amp; Voice Over',
    'svc-post-p':   'Final mix, mastering and VO production in up to 12 languages. Dialogue editing, restoration, casting and delivery, ready for broadcast, streaming or theatrical release.',
    'team-h2':      'The Team',
  ...
  ca: {
    ...
    'svc-music-p':  'Bandes sonores originals per a videojocs, sèries, cinema i cerimònies en viu. De la composició orquestral a la producció electrònica, construïdes al voltant de la teva història.',
    'svc-sound-h3': 'Disseny de So a Mida',
    'svc-sound-p':  'SFX, ambients i atmosferes sonores creades des de zero. De la textura més subtil fins a l\'impacte més contundent. Cada so col·locat amb intenció.',
    'svc-interactive-h3': 'Àudio per a Mitjans Interactius',
    'svc-interactive-p':  'Música adaptativa i sistemes de so dinàmics per a videojocs. Hem treballat amb estudis que arriben a més de 2.000 milions de jugadors. Sabem com l\'àudio impulsa l\'experiència.',
    'svc-post-h3':  'Post, Mix i Voice Over',
    'svc-post-p':   'Mescla final, masterització i producció de VO en fins a 12 idiomes. Edició de diàleg, restauració, càsting i lliurament per a televisió, streaming o estrena en sales.',
    'team-h2':      'L\'Equip',
  ...
  es: {
    ...
    'svc-music-p':  'Bandas sonoras originales para videojuegos, series, cine y ceremonias en vivo. De la composición orquestal a la producción electrónica, construidas alrededor de tu historia.',
    'svc-sound-h3': 'Diseño de Sonido a Medida',
    'svc-sound-p':  'SFX, ambientes y atmósferas sonoras creadas desde cero. Desde la textura más sutil hasta el impacto más duro. Cada sonido colocado con intención.',
    'svc-interactive-h3': 'Audio para Medios Interactivos',
    'svc-interactive-p':  'Música adaptativa y sistemas de sonido dinámicos para videojuegos. Hemos trabajado con estudios que llegan a más de 2.000 millones de jugadores. Sabemos cómo el audio impulsa la experiencia.',
    'svc-post-h3':  'Post, Mix y Voice Over',
    'svc-post-p':   'Mezcla final, masterización y producción de VO en hasta 12 idiomas. Edición de diálogo, restauración, casting y entrega lista para televisión, streaming o estreno en salas.',
    'team-h2':      'El Equipo',
  ...
  fr: {
    ...
    'svc-music-p':  'Musiques originales pour jeux vidéo, séries, films et cérémonies live. De la composition orchestrale à la production électronique, construites autour de votre histoire.',
    'svc-sound-h3': 'Sound Design Sur Mesure',
    'svc-sound-p':  'SFX, ambiances et atmosphères sonores créées de zéro. De la texture la plus subtile à l\'impact le plus fort. Chaque son placé avec intention.',
    'svc-interactive-h3': 'Audio pour les Médias Interactifs',
    'svc-interactive-p':  'Musique adaptative et systèmes sonores dynamiques pour les jeux vidéo. Nous avons travaillé avec des studios atteignant plus de 2 milliards de joueurs. Nous savons comment l\'audio stimule l\'engagement.',
    'svc-post-h3':  'Post, Mix et Voice Over',
    'svc-post-p':   'Mix final, mastering et production VO en jusqu\'à 12 langues. Montage dialogue, restauration, casting et livraison pour la diffusion, le streaming ou la sortie en salles.',
    'team-h2':      'L\'Équipe',
